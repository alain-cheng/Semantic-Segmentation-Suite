...
# Save image
###
def __write_image__(image, file, suffix="pred"):
...
def main():
    ...
    num_classes, *model = __init_model__()
    ...
    for file in files_list:
        ...
        __write_image__(out_mask, file, "mask");
        __write_image__(input_image, file, "image");
